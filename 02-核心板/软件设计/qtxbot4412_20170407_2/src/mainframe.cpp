...
void Mainframe::initConnect()
{
	...
	connect(serialPortThread, SIGNAL(robotDataSignal()), this, SLOT( readyRead()));
	connect(serialPortThread, SIGNAL(keyDataSignal()), this, SLOT( disposejoy()));
...
{	
	...
	switch(a)
	{
		case 0x80:
			...
			if(backdata[6]!=receiveFrame->robotData.feedData5)//电池电压1
			{
				backdata[6]=receiveFrame->robotData.feedData5;
		...
		case 0x81:
			...
			if(backdata[11]!=receiveFrame->robotData.feedData5)//电池电压2
			{
				backdata[11]=receiveFrame->robotData.feedData5;
		...
		case 0x82:
			...
			if(backdata[16]!=receiveFrame->robotData.feedData5)//电池电压3
			{
				backdata[16]=receiveFrame->robotData.feedData5;
		...
		case 0x83:
			...
			if(backdata[21]!=receiveFrame->robotData.feedData5)//电池电压4
			{
				backdata[21]=receiveFrame->robotData.feedData5;
