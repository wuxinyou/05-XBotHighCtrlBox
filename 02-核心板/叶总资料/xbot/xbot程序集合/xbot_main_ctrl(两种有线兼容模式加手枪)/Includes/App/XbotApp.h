...
private:
	...
	volatile bool reGunSendOk;								//手枪发射发送完成标志 默认完成 为true
	bool  WireType;														//线缆盘类型标志
