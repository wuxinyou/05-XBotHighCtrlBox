...
// 	#define XBOT_SUB_ARM0			((uint32_t)(-35))
	...
	#define XBOT_LLL_ARM0				(ARM0_ANGLE_200+XBOT_SUB_ARM0)
	...
	#define XBOT_LLL_ARM0				ARM0_ANGLE_200
...
#define XBOT_BBBB_ARM2		-18000
#define XBOT_BBBB_ARM3 		18000
#define XBOT_BBBB_ARM4		18000
#define XBOT_BBBB_ARM5 		0
#define XBOT_BBBB_ARM6		-2900
#define XBOT_BBBB_ARM7		0

#define XBOT_CCCC_ARM0		XBOT_LLL_ARM0
...
#define XBOT_CCCC_ARM6		18000
#define XBOT_CCCC_ARM7		0

#define XBOT_DDDD_ARM0		XBOT_LLL_ARM0
#define XBOT_DDDD_ARM1		-27000
#define XBOT_DDDD_ARM2		-6000
#define XBOT_DDDD_ARM3 		10000
#define XBOT_DDDD_ARM4		11100
#define XBOT_DDDD_ARM5 		-27000
#define XBOT_DDDD_ARM6		8800
#define XBOT_DDDD_ARM7		27000
#define XBOT_DDDD_ARM8		0

#define XBOT_EEEE_ARM0		XBOT_LLL_ARM0
#define XBOT_EEEE_ARM1		27000
#define XBOT_EEEE_ARM2		-6000
#define XBOT_EEEE_ARM3 		10000
#define XBOT_EEEE_ARM4		11100
#define XBOT_EEEE_ARM5 		27000
#define XBOT_EEEE_ARM6		8800
#define XBOT_EEEE_ARM7		-27000
#define XBOT_EEEE_ARM8		8300

// #define XBOT_DDDD_ARM0		XBOT_LLL_ARM0
// #define XBOT_DDDD_ARM1		0
// #define XBOT_DDDD_ARM2		-4000
// #define XBOT_DDDD_ARM3 		7200
// #define XBOT_DDDD_ARM4		7100
// #define XBOT_DDDD_ARM5 		-27000
// #define XBOT_DDDD_ARM6		13200
// #define XBOT_DDDD_ARM7		0
// #define XBOT_DDDD_ARM8		0

// #define XBOT_EEEE_ARM0		XBOT_LLL_ARM0
// #define XBOT_EEEE_ARM1		0
// #define XBOT_EEEE_ARM2		-4000
// #define XBOT_EEEE_ARM3 		7200
// #define XBOT_EEEE_ARM4		7100
// #define XBOT_EEEE_ARM5 		27000
// #define XBOT_EEEE_ARM6		13200
...
#define LRMOTERMAXSPEED_WIRE_WORK				8000				//有线速度减慢
...
//设置最大参考速度
	...
	fingerMediateM->		setReferSpeedMax(REFER_SPEED_MAX_ARM8);
//设置最小参考速度
	...
	fingerMediateM->		setReferSpeedMin(REFER_SPEED_MIN_ARM8);
...
void XbotApp::runOnTime2()
{
	...
	if(power->checkPowerKey())								//检测电源按键是否按下 如果按下复位保存指令
	{
		resetSave();
	}
...
// 	static uint8_t temFlag=0;									//测试信号强度的标志
...
void XbotApp::sendSaveCommand()
{
	...
	{
		SysTick_DelayMs(4000);				//延时2000MS，保证驱动器有足够的时间保存角度
		power-> shutDown();
		power->sendPowerOnOffCommand();
		return;
	}
...
void XbotApp::checkOffLimit()
{
	...
	if(checkTime[0]<CHECK_TIME_MAX)
	{
		if(BaseControl::reciveData(armPort))
		{
			...
			if(temData[1]==0x00&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[1]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x01&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[2]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x02&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[3]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x03&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[4]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x04&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[5]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x05&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[6]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x06&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
	...
	if(checkTime[7]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x07&&temData[2]==FB_FREE_POS_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
...
void XbotApp::checkReInit()
{
	...
	if(checkTime[0]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x00&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[0]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[1]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x01&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[1]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[2]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x02&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[2]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[3]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x03&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[3]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[4]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x04&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[4]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[5]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x05&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[5]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[6]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x06&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[6]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[7]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x07&&temData[2]==FB_REINIT_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[7]=CHECK_TIME_MAX;
			}
		}
...
void XbotApp::checkSave()
{
	...
	if(checkTime[0]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x00&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[0]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[1]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x01&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[1]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[2]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x02&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[2]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[3]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x03&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[3]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[4]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x04&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[4]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[5]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x05&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[5]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[6]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x06&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[6]=CHECK_TIME_MAX;
			}
		}
	...
	if(checkTime[7]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x07&&temData[2]==FB_SAVE_ID&&temData[3]==FB_OK_1&&temData[4]==FB_OK_2)
			{
				checkTime[7]=CHECK_TIME_MAX;
			}
		}
...
void XbotApp::checkEnaSpeed()
{
	...
	if(checkTime[0]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x00&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[1]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x01&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[2]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x02&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[3]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x03&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[4]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x04&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[5]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x05&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[6]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x06&&temData[2]==FB_ENASPEED_ID)
			{
	...
	if(checkTime[7]<CHECK_TIME_MAX)
	{
		...
		{
			temData=BaseControl::getReciveData(armDataNum);
			if(temData[1]==0x07&&temData[2]==FB_ENASPEED_ID)
			{
...
{
	static workIdType backWorkId_1=BBBModel;
	static workIdType backWorkId_2=DDDModel;
			...
			if((temData[9]&0x08)==0x08)//摆臂模式控制位为1
			{
				...
				else if((temData[6]&0x07)==0x05)
				{
					...
					else
					{
						...
						{
							if(ABS(XBOT_CCCC_ARM2-(fBbigArmPitchA->DATA_16))<300)//此处已经修改为了磨合程序
								backWorkId_1=BBBModel;
							if(ABS(XBOT_BBBB_ARM2-(fBbigArmPitchA->DATA_16))<300)
								backWorkId_1=CCCModel;
							workId=backWorkId_1;
// 							workId=BBBModel;
						}
						else if((temData[4]&0x07)==0x04&&(temData[9]&0x04)==0x04)
						{
							if(ABS(XBOT_EEEE_ARM1-(fBbigArmRotateA->DATA_16))<300)//此处已经修改为了磨合程序
								backWorkId_2=DDDModel;
							if(ABS(XBOT_DDDD_ARM1-(fBbigArmRotateA->DATA_16))<300)
								backWorkId_2=EEEModel;
							workId=backWorkId_2;
// 							workId=DDDModel;
						}
...
// 	if(opticalBobbinDevice->getNumCounter()>10)
// 	{
...
// 		opticalBobbinDevice->resetNumCounter();
		...
		wireLength=opticalBobbinDevice->getWireLength();
	}
}
...
void XbotApp::updateSendTerminalData()
{
	...
	temBuf[1]|=index;
	temBuf[2]=(uint8_t)((-fBLeftSpeed->DATA_16)/92); //*0.0142 近似为除以96  有符号数
	temBuf[3]=(uint8_t)((-fBRightSpeed->DATA_16)/92);
	if(index==0)
	{
	...
	else if(index==2)
	{
		...
		if(signalType==WIRE_WORK_MODE)//有线和无线分别设置线缆盘剩余线长
		{
			temBuf[6]=wireLength;																	//线缆盘剩余线长
		}
...
#ifdef NEWOPTICALBOBBIN
	if(signalType==WIRE_WORK_MODE)//有线和无线分别设置速度
	{
...
// 			else

			{
				...
				if(opticalBobbinDevice->getWireLength()<5&&signalType==WIRE_WORK_MODE&&\
						(((fBTerminalData[1]&0x0f)==0x01)||((fBTerminalData[1]&0x0f)==0x04)||\
						((fBTerminalData[1]&0x0f)==0x05)))//线缆盘中余下的线长不足5米 并且是有线控制 并且是前进状态
				{
					leftRunM->resetSpeed();
					rightRunM->resetSpeed();
				}
	...
	switch((int)workId)
	{
		...
		if(signalType==WIRE_WORK_MODE)//线缆盘自动收放线
		{
			...
			{
				panTiltPitchM->setErrorFlag_1(setPanTiltPitchSpeed((int16_t)((fBTerminalData[7]&0x07)*1285)));
			}
			else
			{
				panTiltPitchM->setErrorFlag_1(setPanTiltPitchSpeed(-((int16_t)((fBTerminalData[7]&0x07)*1285))));
			...
			{
				panTiltRotateM->setSpeed((int16_t)((fBTerminalData[7]&0x70)>>0x04)*285);
			}
			else
			{
				panTiltRotateM->setSpeed(-((int16_t)((fBTerminalData[7]&0x70)>>0x04)*285));
...
*/
		...
		case DDDModel:
			...
			if(unlockArms(XBOT_DDDD_ARM0))
				allArmRunToPos_test(XBOT_DDDD_ARM1,XBOT_DDDD_ARM2,XBOT_DDDD_ARM3,XBOT_DDDD_ARM4,XBOT_DDDD_ARM5,XBOT_DDDD_ARM6,XBOT_DDDD_ARM7,XBOT_DDDD_ARM0,XBOT_DDDD_ARM8);
			break;
		case EEEModel:
			xyzFlag=false;
			if(unlockArms(XBOT_EEEE_ARM0))
				allArmRunToPos_test(XBOT_EEEE_ARM1,XBOT_EEEE_ARM2,XBOT_EEEE_ARM3,XBOT_EEEE_ARM4,XBOT_EEEE_ARM5,XBOT_EEEE_ARM6,XBOT_EEEE_ARM7,XBOT_EEEE_ARM0,XBOT_EEEE_ARM8);
			break;
		case HHHModel:
...
void XbotApp::allArmRunToPos_test(int angle_1,int angle_2,int angle_3,int angle_4,int angle_5,int angle_6,int angle_7,int angle_8,int angle_9)
{
	int subAngle[9]={0};
	int subtime[9]={0};
	int subMaxTime=0;
...
// 	if(checkBlockError()==false)													//没有电机堵转
	{
		...
		subAngle[6]=(angle_7-(int)fBpanTiltRotateA->DATA_16);
		subAngle[7]=angle_8;
		subAngle[8]=(angle_9-(int)fBfingerMediateA->DATA_16);
// 		subAngle[7]=((int)getSuppArmSubAngle(angle_8))*1125/32;//支臂的角度差单独计算
		...
		subtime[6]=subAngle[6]*SPEED_COEFFICIENT_ARM7;
		subtime[7]=0;
		subtime[8]=subAngle[8]*SPEED_COEFFICIENT_ARM8;
// 		subtime[7]=subAngle[7]*SPEED_COEFFICIENT_ARM0;
...
// 	setSuppArmspeed(subAngle[7],subtime[7],subMaxTime);
		...
		bigArmPitchM->		setSpeedFromSubAngle(setBigArmPitchSpeed,subAngle[1],subtime[1],subMaxTime);
		bigArmRotateM->		setSpeedFromSubAngle(setBigArmRotateSpeed,subAngle[0],subtime[0],subMaxTime);
		fingerMediateM->	setSpeedFromSubAngle(setFingerMediateSpeed,subAngle[8],subtime[8],subMaxTime);
	}
	checkBlockError();
}
...
// 		forearmPitchM->		setSpeedFromSubAngle_1(subAngle[2],subtime[2],subMaxTime);
// 		bigArmPitchM->		setSpeedFromSubAngle_1(subAngle[1],subtime[1],subMaxTime);
// 		bigArmRotateM->		setSpeedFromSubAngle_1(subAngle[0],subtime[0],subMaxTime);
	}
}
/**
...
// 	
	...
	if((data[8]==0)||((data[8]>0?setFingerMediateSpeed(1000):setFingerMediateSpeed(-1000))!=0))
		data[8]=0;
	setFingerMediateSpeed(0);
...
uint8_t XbotApp::setFingerMediateSpeed(int16_t temSpeed)
{
	...
	if(temSpeed<0)
	{
		if(temFingerMediateAngle>600)
			fingerMediateM->setSpeed(temSpeed);
		else if(temFingerMediateAngle>300)
			fingerMediateM->setSpeed(temSpeed/3);
		else if(temFingerMediateAngle>0)
		{
			fingerMediateM->setSpeed(temSpeed/10);
	...
	if(temSpeed<0) //负方向运动
	{
		if(temBigArmPitchAngle>-5100&&temBigArmRotateAngle>-4100&&temBigArmRotateAngle<5100)
		{
			if((temSupportArmAngle>(XBOT_CRITICAL_ARM0_UP_1*1125/32+500))||(temSupportArmAngle<(XBOT_CRITICAL_ARM0_DN*1125/32+500)))
				supportArmM->setSpeed(temSpeed);
			else if(temSupportArmAngle>(XBOT_CRITICAL_ARM0_UP_1*1125/32+200))
			{
	...
	else //正方向运动
	{
		if(temBigArmPitchAngle>-5100&&temBigArmRotateAngle>-4100&&temBigArmRotateAngle<5100)
		{
			if((temSupportArmAngle<(XBOT_CRITICAL_ARM0_DN_1*1125/32-500))||(temSupportArmAngle>(XBOT_CRITICAL_ARM0_UP*1125/32-500)))
				supportArmM->setSpeed(temSpeed);
			else if(temSupportArmAngle<(XBOT_CRITICAL_ARM0_DN_1*1125/32-200))
			{
				supportArmM->setSpeed(temSpeed/3);
			}
		...
		else 
		{
			if(temSupportArmAngle<(ARM0_ANGLE_270*1125/32-500))
				supportArmM->setSpeed(temSpeed);
			else if(temSupportArmAngle<(ARM0_ANGLE_270*1125/32-200))
				supportArmM->setSpeed(temSpeed/3);
...
#define BIGARMSUBANGLE 0.018443
