...
/****************** USART2 端口初始化****************************/
#define GPIO_PinRemapConfig_USART2	GPIO_PinAFConfig(GPIOA, GPIO_PinSource2,	GPIO_AF_USART2);\
																		GPIO_PinAFConfig(GPIOA, GPIO_PinSource3, 	GPIO_AF_USART2)	
																		
#define RCC_ClockCmdGpio_USART2			RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE)	
#define STM32_GpioInit_USART2				STM32_GpioOneInit(GPIO_Pin_2, GPIO_Speed_50MHz, GPIO_Mode_AF,	GPIO_OType_PP, 	GPIO_PuPd_UP,	GPIOA);\
																		STM32_GpioOneInit(GPIO_Pin_3, GPIO_Speed_50MHz, GPIO_Mode_AF,	GPIO_OType_PP, 	GPIO_PuPd_UP,	GPIOA)	
