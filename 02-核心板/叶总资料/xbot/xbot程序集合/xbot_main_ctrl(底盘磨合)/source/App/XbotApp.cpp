...
#define XBOT_DDDD_ARM2		-12400
#define XBOT_DDDD_ARM3 		6500
#define XBOT_DDDD_ARM4		11800
...
// 	led_3= new LEDLighter(GPIOC,GPIO_Pin_5);	//默认点亮
...
void XbotApp::runOnTime3()
{
	...
	if(timeIndex<30000)
	{
		leftRunM->setSpeed(8000);
		rightRunM->setSpeed(-8000);
	}
	else
	{
		leftRunM->setSpeed(-8000);
...
// 	if(ABS(XBOT_LLL_ARM0-fBDiscA->DATA_16)<20)
// 		temAAA=XBOT_JJJ_ARM0;
// 	if(ABS(XBOT_JJJ_ARM0-fBDiscA->DATA_16)<20)
// 		temAAA=XBOT_LLL_ARM0;
// 	suppArmRunToPos(temAAA);
	
	if(flag)
		suppArmRunToPos(XBOT_CRITICAL_ARM0_UP_1);
	else
		suppArmRunToPos(XBOT_CRITICAL_ARM0_DN_1);
	

	if(supportArmM->getSpeed()==0)
	{
...
// 						leftRunM->resetSpeed();				
				 ...
				 if((fBTerminalData[1]&0x0c)==0x04) 
						rightRunM->setSpeed(-(int16_t)((fBTerminalData[2]*LandRMoterMaxSpeed)/150));
					else if((fBTerminalData[1]&0x0c)==0x08)
						rightRunM->setSpeed((int16_t)((fBTerminalData[2]*LandRMoterMaxSpeed)/150));
					else
						rightRunM->resetSpeed();
					
					if((fBTerminalData[1]&0x03)==0x01)
						leftRunM->setSpeed((int16_t)((fBTerminalData[3]*LandRMoterMaxSpeed)/150));
