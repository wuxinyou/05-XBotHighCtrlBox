...
**
** Created: Wed Mar 27 11:55:11 2013
...
static const char qt_meta_stringdata_Speed[] = {
    "Speed\0"
};

const QMetaObject Speed::staticMetaObject = {
    { &AbstractMeter::staticMetaObject, qt_meta_stringdata_Speed,
      qt_meta_data_Speed, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Speed::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Speed))
        return static_cast<void*>(const_cast< Speed*>(this));
