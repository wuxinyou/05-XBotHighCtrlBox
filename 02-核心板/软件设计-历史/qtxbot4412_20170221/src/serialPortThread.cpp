...
SerialPortThread::SerialPortThread(ReceiveFrame *recData)
{
	receiveFrame=recData;
...
void SerialPortThread::sendData()
{
    ...
    ::write(m_fd, text.data(), 2*text.length());// 缁忓疄楠 寰楄鍙栧埌鐨勯暱搴︿箻2鎵嶈兘鏀跺緱鍏    //ui->m_sendEdit->setText("");
