...
**
** Created: Wed Mar 20 15:51:15 2013
...
public:
    ...
    void setupUi(QDialog *mainframe)
    {
        ...
        serialport->setTimeout(10u);
        serialport->setAutoOpen(false);
        label = new QLabel(mainframe);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(620, 270, 151, 21));
        QPalette palette1;
        ...
        avideo->setGeometry(QRect(690, 60, 80, 80));
    ...
    void retranslateUi(QDialog *mainframe)
    {
        ...
        label->setText(QApplication::translate("mainframe", "M2:\351\242\204\347\275\256\344\275\215\346\250\241\345\274\217", 0, QApplication::UnicodeUTF8));
