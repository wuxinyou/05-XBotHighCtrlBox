...
void Modle_2d::paintEvent(QPaintEvent *event)
{
	...
	*/
	...
	painter.drawText(63,20,QString::number(value_1*2));//"大臂俯仰:"+
	
	painter.drawText(63,40,QString::number(value_2*2));//"小臂俯仰:"+
	
	painter.drawText(63,60,QString::number(value_3*2));//"手腕俯仰:"+
	
	painter.drawText(63,80,QString::number(value_4*2));//"云台俯仰:"+
	
	painter.drawText(301,20,QString::number(value_5*2));//"手抓捏合:"+
	
	painter.drawText(301,40,QString::number(value_6*2));//"手抓旋转:"+
	
	painter.drawText(301,60,QString::number(value_7*2));//"大臂旋转:"+
	
	painter.drawText(301,80,QString::number(value_8*2));//"云台旋转:"+
