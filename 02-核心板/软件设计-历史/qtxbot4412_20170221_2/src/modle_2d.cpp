...
void Modle_2d::paintEvent(QPaintEvent *event)
{
	...
	painter.drawText(3,15,"大臂俯仰:"+QString::number(value_1*2));
	
	painter.drawText(3,35,"小臂俯仰:"+QString::number(value_2*2));
	
	painter.drawText(3,55,"手腕俯仰:"+QString::number(value_3*2));
	
	painter.drawText(3,75,"云台俯仰:"+QString::number(value_4*2));
	
	painter.drawText(260,15,"手抓捏合:"+QString::number(value_5*2));
	
	painter.drawText(260,35,"手抓旋转:"+QString::number(value_6*2));
	
	painter.drawText(260,55,"大臂旋转:"+QString::number(value_7*2));
	
	painter.drawText(260,75,"云台旋转:"+QString::number(value_8*2));
