...
* rozpoczyna³a si?jak najbli¿ej warto¶ci minimalnej lub koñczy³a jak najbli¿ej warto¶ci
* maksymalnej.
*
* @param m_minimum - warto¶æ minilana na skali jaka ma by?widoczna
* @param m_maximum - warto¶æ maksymalna na skali jaka ma by?widoczna
* @param m_min     - wyliczona warto¶æ pocz±tkowa skali
* @param m_max     - wyliczona warto¶æ koñcowa skali
* @param stesp     - ilo¶æ wêz³ów jak?ma mie?skala
* @param left      - czy skala ma by?wyrównana do lewej czy do prawej (domy¶lnie do prawej).
* @return Funkcja zwraca warto¶æ true je¿eli warto¶ci m_min oraz m_max w wyniku zmiany zakresu
* zmieni³y swoj?warto¶æ.  Na podstawie tej warto¶ci wiadomo czy nale¿y np. przerysowa?skal?* - podaj±c wcze¶niej poprzednie warto¶ci zakresu skali.
*/

template <typename T> //Ä£°åº¯Êý ÏÞ¶¨·¶Î§µÄÄ£°åº¯Êý
